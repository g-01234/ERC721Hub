...
// contract SampleERC721Hub is Owned {
...
//     modifier onlyCanvas(uint256 _tokenId) {
//         require(msg.sender == canvases[_tokenId], "NOT_CANVAS");
//         _;
//     }
...
//         address canvas = canvases[_tokenId];
//         if (msg.sender != canvases[_tokenId]) {
//             require(isAuthorized(msg.sender, _tokenId), "NOT_AUTHORIZED");
//             IERC721(canvas).approve(_approved, _tokenId);
//             // (bool success, ) = canvas.delegatecall(
//             //     abi.encodeWithSelector(
//             //         IERC721(canvas).approve.selector,
//             //         _approved,
//             //         _tokenId
//             //     )
//             // );
...
//         console.log(msg.sender, _operator);
